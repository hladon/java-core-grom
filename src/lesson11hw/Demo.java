...
public class Demo {
	...
	public static void main(String[] args) {
		...
		test=cont.check(new GoogleAPI(test1), new BookingComAPI(trip));
		...
		test=cont.check(new GoogleAPI(test2), new BookingComAPI(trip));
		...
		test=cont.check(null, new BookingComAPI(trip));
